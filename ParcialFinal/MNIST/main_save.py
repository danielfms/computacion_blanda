...
with tf.Session() as sess:
    ...
    accu = sess.run(accuracy, feed_dict={x: mnist.test.images[:256], y: mnist.test.labels[:256], keep_prob: 1.})
 
    #print "Testing Accuracy:", sess.run(accuracy, feed_dict={x: mnist.test.images[:256], y: mnist.test.labels[:256], keep_prob: 1.}) 
    print "Testing Acurracy:", accu    
    ...
    image = cv2.imread('./Sample/digit.jpg',0)
    ...
    print(final)
    digit = numpy.argmax(final)    
    #print "Maybe is  : ", digit, 'Digit'
